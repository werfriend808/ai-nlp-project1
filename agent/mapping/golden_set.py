...
TABLE_ID_OVERRIDES: dict[str, str] = {
    ...
    # 온라인쇼핑 거래액: 취급상품범위별(DT_1KE10041, 종합몰/전문몰) 버전은 새로 안 만들고
    # 판매매체별(DT_1KE10071, 모바일/인터넷) 버전으로 흡수 — 같은 온라인쇼핑동향조사의 다른
    # 분류축일 뿐 전체 합계는 동일하고, DT_1KE10071엔 "이쿠폰서비스" 항목(objL1=020)까지
    # 이미 있어서 A034 골든셋 3건(합계/증가율/이쿠폰) 전부 커버함 (2026-08-04 확인).
    "DT_1KE10041": "DT_1KE10071",
}
